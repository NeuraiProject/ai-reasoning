    ...
    <div className="flex flex-col h-screen mx-auto items justify-end text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-900">
      {status === null && messages.length === 0 && (
        <div className="h-full overflow-auto scrollbar-thin flex justify-center items-center flex-col relative">
          <div className="flex flex-col items-center mb-1 max-w-[800px] text-center">
            <img
              src="neurai-logo.svg"
              width="40%"
              height="auto"
            ...
            ></img>
            <h1 className="text-4xl font-bold mb-1">Neurai DeepSeek-R1</h1>
            <h2 className="font-semibold">
              A reasoning model that runs locally in your browser with WebGPU acceleration.
            </h2>
          </div>
          ...
          <div className="flex flex-col items-center px-4">
            <p className="max-w-[700px] mb-4">
              ...
              is available on{" "}
              <a
                href="https://github.com/neuraiproject/ai-reasoning"
                target="_blank"
                rel="noreferrer"
                className="font-medium underline"
              >
